...
#define SDA_IN() (GPIO_PORT_DIR &= ~(1<<SIMULATION_IIC_SDA_PIN))
#define SDA_OUT()  (GPIO_PORT_DIR |= (1<<SIMULATION_IIC_SDA_PIN))
...
TWI_EXT void I2cSimulationSendByte(uint8_t data);
