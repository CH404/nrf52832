...
#define BATTERY_SAADC_OFFSET 0.02
#if 0
...
void BatteryTimerBackCall(TimerHandle_t xTimer)
{
	...
	NRF_LOG_INFO("voltage"NRF_LOG_FLOAT_MARKER "V",NRF_LOG_FLOAT(battery_Value));
		//battery_Value = (420 - battery_Value)/40;
//LCD_RefreshBattery(battery_Value);
//NRF_LOG_INFO("V： %d ",battery_Value);
...
//用于画 ... (hrs开启)
	...
	battery_timer = xTimerCreate("bty",2000,pdTRUE,(void*)2,BatteryTimerBackCall);
