...
//rtc task
#define RTC_UPDATE_TASK_SIZE 81
...
//任务通知
#define ESP_TO_LCD_NOTIFY_BIT 0xFFFFFFF7
#define RTC_TO_LCD_NOTIFY_BIT 0xFFFFFFFB
#define IT725_TO_LCD_NOTIFY_BIT 0xFFFFFFFD
#define MPU6050_TO_LCD_NOTIFY_BIT 0xFFFFFFE
