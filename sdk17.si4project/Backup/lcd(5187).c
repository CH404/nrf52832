...
#define LCD_ICON_BATTERY_POS_X 35
#define LCD_ICON_BATTERY_POS_Y 35
#define LCD_ICON_BATTERY_WIDTH 6
#define LCD_ICON_BATTERY_HIGHT 12
...
void lcd_RefreshBattery(uint8_t level)
{
	...
	ST7789_DrawRectangle(LCD_ICON_BATTERY_POS_X,LCD_ICON_BATTERY_POS_Y,\
		...
		WHITE);
	ST7789_Fill(LCD_ICON_BATTERY_POS_X-3,LCD_ICON_BATTERY_POS_Y+2,LCD_ICON_BATTERY_POS_X-2,LCD_ICON_BATTERY_POS_Y+3,WHITE);
		...
		x = LCD_ICON_BATTERY_POS_X+(LCD_BATTERT_ONE_LEVEL_WIDTH*level);
