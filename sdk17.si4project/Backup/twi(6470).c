...
#define TWI0_SDA_PIN 10
#define TWI0_SCL_PIN 12
...
ret_code_t TWI_Init(void)
{
	...
	err_code = nrf_drv_twi_init(&twi0,&config,twi_handler,NULL);
...
void test1(void)
{
	...
	TWI_Init();
     //  err =  nrf_drv_twi_tx(&twi0,IT725X_ADDRESS,NULL,0,false);
