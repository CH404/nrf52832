...
//	LCD_Init();
	SPI_SoftWareInit();
//	spidata[0] = SPI_ReadByte(0x04);
	spidata[1] = SPI_ReadByte(0x0B);
	spidata[2] = SPI_ReadByte(0x0C);
	spidata[3] = SPI_ReadByte(0x0D);
	spidata[4] = SPI_ReadByte(0x0E);
